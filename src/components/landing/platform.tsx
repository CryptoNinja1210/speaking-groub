      ...
      <div className='tw-bg-culture-gradient tw-flex tw-min-h-[1168px] tw-items-center'>
        <div className=' tw-flex tw-flex-col tw-justify-between tw-max-w-[1370px] tw-min-h-[912px] tw-m-auto sm:tw-p-5 tw-p-0'>
          <div className=" tw-max-w-[1248px] tw-flex tw-flex-col tw-justify-center tw-items-center xl:tw-py-0 tw-py-12">
            <div className=" tw-text-center tw-leading-[100%] tw-text-[2rem] sm:tw-text-[2.25rem] md:tw-text-[60px] tw-font-sans tw-text-[#00B687]">Join our International Conversation Club now to start your language learning journey.<br /> Meet new friends, learn languages, and explore new cultures. </div>
          ...
          <div className=" tw-bg-white tw-rounded-[36px] tw-min-h-[584px] tw-p-3 sm:tw-p-[80px] tw-font-sans tw-flex tw-flex-col tw-justify-between tw-items-center tw-shadow-xl">
            <div className=" tw-flex tw-flex-col xl:tw-flex-row tw-items-center tw-justify-between tw-w-full">
              <div className=" tw-w-[330px] tw-pb-[60px] tw-pb-[0px]">
                <div className=" tw-text-[#00B687] tw-text-[2rem] tw-leading-[90%]">Connect with Like-minded Individuals:</div>
              ...
              <div className=" tw-w-[330px] tw-pb-[60px] tw-pb-[0px]">
                <div className=" tw-text-[#00B687] tw-text-[2rem] tw-leading-[90%]">Engage in Meaningful Conversations:</div>
              ...
              <div className=" tw-w-[330px] tw-pb-[60px] tw-pb-[0px]">
                <div className=" tw-text-[#00B687] tw-text-[2rem] tw-leading-[90%]">Build a Community of Similar Interests:</div>
